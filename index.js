...
function init() {
    // set up the the scene, the camera and the renderer
    createScene();
...
function createScene() {
    ...
    // create a fog effect with the same color as the css
    ...
    renderer = new THREE.WebGLRenderer({
        // we want to see our css background so we set alpha to true in order
    ...
    // in this case we set it to fill our screen
...
function createLights() {
    // the hemisphereLight is a gradient light
    // sky light, ground light, intensity
    hemisphereLight = new THREE.HemisphereLight(0xaaaaaa,0x000000, .9);

    // a directional light shines in a specific direction
    ...
    ambientLight = new THREE.AmbientLight(0xa64dff, .9);
...
//////////////////////////////////////////////////////////////////////////////// TODO: asociate the pilot with the plane
var Pilot = function(){
    this.mesh = new THREE.Object3D();
